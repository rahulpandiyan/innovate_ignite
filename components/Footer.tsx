        ...
        <div className="grid grid-cols-12 gap-8 py-12 lg:py-14">
          <div className="col-span-12 lg:col-span-5">
            ...
            <p className="mt-3 max-w-md text-sm leading-6 text-white/60">
              Vijaya Vittala Institute Of Technology presents Innovate Ignite — 14 stages, 5 domains, one campus.
          ...
          <div className="col-span-6 sm:col-span-4 lg:col-span-2">
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              ...
              <li><Link href="/events" className="text-white/70 hover:text-white transition-colors">Events — 14 stages</Link></li>
