...
import { ShieldCheck, LogOut, EllipsisVertical, Trophy, Scale } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
export function JudgeShell({
  ...
  const isActive = pathname === "/judge" || pathname.startsWith("/judge/");
            ...
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild>
                <Link href="/judge">
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    <span className="truncate font-semibold">Judging</span>
                    <span className="truncate text-xs">Scoring desk</span>
                  </div>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
        ...
        <SidebarContent>
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive} tooltip="Score events">
                    <Link href="/judge">
                      <Trophy />
