...
import { ShieldCheck, LogOut, EllipsisVertical, Award, FileBadge } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
export function CertShell({
  ...
  const isActive = pathname === "/certificates" || pathname.startsWith("/certificates/");
            ...
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild>
                <Link href="/certificates">
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    <span className="truncate font-semibold">Certificates</span>
                    <span className="truncate text-xs">Issuing desk</span>
                  </div>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
        ...
        <SidebarContent>
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive} tooltip="Issue certificates">
                    <Link href="/certificates">
                      <FileBadge />
