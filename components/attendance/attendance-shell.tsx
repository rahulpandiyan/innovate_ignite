...
import { ShieldCheck, LogOut, EllipsisVertical, CheckCheck } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
            ...
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild>
                <Link href="/attendance">
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    <span className="truncate font-semibold">Check-in Desk</span>
        ...
        <SidebarContent>
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive} tooltip="Attendance overview">
                    <Link href="/attendance">
                      <CheckCheck />
