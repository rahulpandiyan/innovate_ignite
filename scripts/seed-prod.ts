...
async function seedEvents(superAdminId: string) {
  const events = [
    ...
    },
    {
      ...
      venue: "Classrooms",
      rules: "Squad of 4 | ₹200 per team | Offline campus-only, Oct 9 | Prize pool up to ₹5000 | IGL is primary contact | Faculty: Subhrajit Sengupta, Manjunatha | Students: Arshad, Charan",
    },
    {
    ...
    },
    {
      ...
      rules: "Team 2-3 | ₹100 per team | Topic announced at venue | Choose FOR or AGAINST | 5 min prep | Every member must speak | Faculty: Selva Agnes, Supriya P | Students: Thannavee 7204967325, Lavanya 8296876822",
    },
  ];
