...
async function seedEvents(superAdminId: string) {
  const events = [
    ...
    },
    {
      ...
      maxTeamSize: 4,
      status: "OPEN" as const,
      rules: "Squad of 4 | ₹200 per team | Online + offline modes | One player designated as In-Game Leader (IGL) & primary contact | Coordinators: Subhrajit, Kumari Manjunatha | Students: Al Arshad, Charan",
    },
    {
      name: "Free Fire",
      category: "GAMING",
    ...
    },
    {
      ...
      maxTeamSize: 2,
      status: "OPEN" as const,
      rules: "Solo ₹50 / Group ₹150 | One song per participant/team | Max 4 min | Any language & genre | Lip-sync and pre-recorded vocals prohibited | Coordinators: Agnes Stephen | Students: Thannavee, Lavanya",
    },
    {
