...
async function seedEvents(superAdminId: string, coordinatorId: string, judgeId: string) {
  const events = [
    ...
    },
    {
      ...
      rules: "Squad of 4 | ₹200 per team | Offline campus-only squad for BGMI and Free Fire | Prize pool up to ₹5000 | IGL is primary contact | Faculty: Manjunatha, Subhrajit Sengupta | Students: Arshad, Charan",
      faculty: "Manjunatha, Subhrajit Sengupta",
