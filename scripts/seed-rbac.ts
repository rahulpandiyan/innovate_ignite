...
async function seedEvents(superAdminId: string, coordinatorId: string, judgeId: string) {
  const events = [
    ...
    },
    {
      ...
      rules: "Faculty: Rajani M, M G Kousar | Students: Srishty, Lalitha",
      faculty: "Rajani M, M G Kousar",
      students: [{ name: "Srishty", phone: null }, { name: "Lalitha", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      rules: "Faculty: Rashmi Rani Samantaray | Students: Anushka S, Arshiya",
      faculty: "Rashmi Rani Samantaray",
      students: [{ name: "Anushka S", phone: null }, { name: "Arshiya", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      maxTeamSize: 3,
      status: "OPEN" as const,
      date: new Date("2026-10-08T13:30:00.000Z"),
    ...
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-08T11:00:00.000Z"),
      rules: "Faculty: Selva Agnes | Students: Thanavee, Lavanya",
      faculty: "Selva Agnes",
      students: [{ name: "Thanavee", phone: null }, { name: "Lavanya", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      rules: "Faculty: Swetha, Harini | Students: Lokhapradeep, Harish P, Deekshitha A",
      faculty: "Swetha, Harini",
      students: [{ name: "Lokhapradeep", phone: null }, { name: "Harish P", phone: null }, { name: "Deekshitha A", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-09T09:30:00.000Z"),
      rules: "Faculty: Supriya | Students: Dhikshitha A, Divya C",
      faculty: "Supriya",
      students: [{ name: "Dhikshitha A", phone: null }, { name: "Divya C", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
    ...
    },
    {
      ...
      rules: "Faculty: Subhrajit Sengupta | Students: Arshad, Charan",
      faculty: "Subhrajit Sengupta",
      students: [{ name: "Arshad", phone: null }, { name: "Charan", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
    ...
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-09T09:30:00.000Z"),
      rules: "Faculty: Sushma B M, Bharathi J | Students: Harish, Divya C",
      faculty: "Sushma B M, Bharathi J",
      students: [{ name: "Harish", phone: null }, { name: "Divya C", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
