  ...
  const events = [
    {
      ...
      rules: "Team 1-4 | ₹100 per team | Tech-based event | Coordinator: M G Kousar | Students: Sam Goldwin, Rahul",
      faculty: "M G Kousar",
    ...
    },
    {
      ...
      students: [{ name: "Srishty Singh", phone: null }, { name: "Lalitha Sreenivasan", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      rules: "Squad of 4 | ₹50 per member | Online + offline modes | Coordinators: Subhrajit, Kumari Manjunatha | Students: Al Arshad, Charan",
      faculty: "Subhrajit, Kumari Manjunatha",
      students: [{ name: "Al Arshad", phone: null }, { name: "Charan", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-09T10:00:00.000Z"),
      rules: "Solo | ₹50 | Talent show | Max 150s | Coordinators: Kavyashree | Students: Shree Guggilam, M. Harshitha",
      faculty: "Kavyashree",
      students: [{ name: "Shree Guggilam", phone: null }, { name: "M. Harshitha", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-09T10:00:00.000Z"),
      rules: "Team 1-4 | ₹100 per team | Creative reel on the given theme | Coordinators: Sushma B M, Bharathi J",
    ...
    },
    {
      ...
      rules: "Individual | ₹50 | Persona-based speaking | Real figures only | Coordinators: Harini, Swetha | Students: Dhikshitha, Harish, Lokicodgameplay",
      faculty: "Harini, Swetha",
      students: [{ name: "Dhikshitha", phone: null }, { name: "Harish", phone: null }, { name: "Lokicodgameplay", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
    ...
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-09T10:00:00.000Z"),
      rules: "Team 3-10 | ₹200 per team | Any dance form, 5-7 min | Coordinator: J Bharathi | Students: Krishnaveni H K, Lahari M, Bhoomika",
      faculty: "J Bharathi",
      students: [{ name: "Krishnaveni H K", phone: null }, { name: "Lahari M", phone: null }, { name: "Bhoomika", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      rules: "Team 3-4 | ₹200 per team | CS/EC/AI-ML projects | Coordinators: Rashmi, Vanitha | Students: Anushka, Rajaditya Raj, Sneha",
      faculty: "Rashmi, Vanitha",
      students: [{ name: "Anushka", phone: null }, { name: "Rajaditya Raj", phone: null }, { name: "Sneha", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      students: [{ name: "Anushka", phone: null }, { name: "Mohammed Ghouse", phone: null }, { name: "Daniel", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      students: [{ name: "Thannavee", phone: null }, { name: "Lavanya", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      status: "OPEN" as const,
      date: new Date("2026-10-08T11:00:00.000Z"),
      rules: "Team 2-3 | ₹100 per team | Topic at venue | Coordinators: Agnes Stephen | Students: Thannavee, Lavanya",
      faculty: "Agnes Stephen",
      students: [{ name: "Thannavee", phone: null }, { name: "Lavanya", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
...
async function main() {
  ...
  if (!existingTeam) {
    const bop = events.find((e) => e.name === "BGMI & Free Fire")!;
