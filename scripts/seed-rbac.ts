...
async function seedEvents(superAdminId: string, coordinatorId: string, judgeId: string) {
  const events = [
    ...
    },
    {
      ...
      students: [{ name: "Dhikshitha", phone: "+917892563979" }, { name: "Harish", phone: "+919901709596" }, { name: "Lokicodgameplay", phone: "+919632425042" }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
    ...
    },
    {
      ...
      faculty: "J Bharathi",
      students: [{ name: "Krishnaveni H K", phone: "+919743116619" }, { name: "Lahari M", phone: "+918884084501" }, { name: "Bhoomika", phone: null }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
      ...
      students: [{ name: "Anushka", phone: "+918197197536" }, { name: "Rajaditya Raj", phone: "+919341606324" }, { name: "Sneha", phone: "+919341435924" }],
      assignCoordinatorId: coordinatorId,
      assignJudgeId: judgeId,
    },
    {
